These notes are for the EDITORS of cryoem
...
Make sure you have an ID range in the [idranges file](cryoem-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [cryoem-edit.owl](cryoem-edit.owl)

** DO NOT EDIT cryoem.obo OR cryoem.owl in the top level directory **

[../../cryoem.owl](../../cryoem.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/I2PC/cryoem) for details.
 ...
 * [cryoem-idranges.owl](cryoem-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/cryoem_terms.txt file
...
Note: the cryoem_terms.txt file may include 'starter' classes seeded from
...
This generates derived files such as cryoem.owl and cryoem.obo and places
 ...
 * https://github.com/I2PC/cryoem/releases
 * https://github.com/I2PC/cryoem/releases/new
...
what is in the `owl:versionIRI` of the derived cryoem.owl (`data-version` in
cryoem.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/cryoem.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/cryoem/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/I2PC/cryoem.svg?branch=master)](https://travis-ci.org/I2PC/cryoem)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/I2PC](https://travis-ci.org/profile/I2PC)
 2. click the "Sync account" button
 3. Click the tick symbol next to cryoem
